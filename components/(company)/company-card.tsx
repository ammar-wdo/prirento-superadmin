...
<Image src={company.logo} alt='logo' fill className='rounded-md object-cover'/>
        </div>
        ...
        <NavigatorButton href={`/dashboard/company/${company.id}`} title='Edit' className='w-full mt-8'/>
        <ClientModalButton  modal='delete' deleteId={company.id} delete={deleteCompany} data={{}} destructive className='w-full mt-1'>Delete</ClientModalButton>
