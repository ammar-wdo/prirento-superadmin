...
const CarDiscountForm = (props: Props) => {
  const {
    form,
    onSubmit,
    times,
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                ...
                <Input placeholder="promocode" className="border-0 flex-1 " {...field} />
...
<FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent>
             {discountType.map(type=> <SelectItem className="capitalize cursor-pointer" key={type} value={type}>{type}</SelectItem>)}
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <Select onValueChange={field.onChange} defaultValue={field.value}>
                ...
                <SelectContent>
             {discountApplyType.map(type=> <SelectItem className="capitalize cursor-pointer" key={type} value={type}>{type}</SelectItem>)}
        ...
        <ActionLoaderButton isLoading={form.formState.isSubmitting}>
          {modalInputs?.modal === "carDiscount" &&
          modalInputs.carDiscount
            ? "Update"
            : "Submit"}
        </ActionLoaderButton>
      </form>
